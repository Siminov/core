...
namespace Siminov.Core.Database
{
    ...
    /// </summary>
    public class DeleteImpl : IDelete
    {
        ...
        private DeleteClauseImpl where = null;
        ...
        private DeleteClauseImpl having = null;
        ...
        public IDeleteClause Where(String column)
        {
            ...
            where = new DeleteClauseImpl(this);
            where.AddCol(column);
        ...
        /// <returns>Where instance object</returns>
        public IDelete OrderBy(String[] columns)
        {
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public IDelete AscendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = DeleteClauseImpl.ASC_ORDER_BY;
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public IDelete DescendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = DeleteClauseImpl.DESC_ORDER_BY;
        ...
        /// <returns>Where instance object</returns>
        public IDelete Limit(int limit)
        {
            this.limit = limit;
            return this;
        }
        ...
        /// <returns>Where instance object</returns>
        public IDelete GroupBy(String[] columns)
        {
        ...
        /// <returns>Clause instance object</returns>
        public IDeleteClause Having(String column)
        {

            having = new DeleteClauseImpl(this);
        ...
        /// <returns>Where instance object</returns>
        public IDelete HavingClause(String havingClause)
        {
            this.havingClause = havingClause;
            return this;
        }

        public IDelete Column(String column)
        {
            this.column = column;
            return this;
        }
        ...
        /// <param name="columns">Name of columns</param>
        /// <returns>Where instance object</returns>
        public IDelete Columns(String[] columns)
        {
        ...
        /// <returns>Where instance object</returns>
        public IDelete Delimiter(String delimiter)
        {
