...
namespace Siminov.Core.Database
{
    ...
    public class MinImpl : IMin
    {
        ...
        private MinClauseImpl where = null;
        ...
        private MinClauseImpl having = null;
        ...
        public MinImpl(EntityDescriptor entityDescriptor)
        {
        ...
        public MinImpl(EntityDescriptor entityDescriptor, Object referObject)
        {
            this.entityDescriptor = entityDescriptor;
        ...
        /// <returns>Where instance object</returns>
        public IMin OrderBy(String[] columns)
        {
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public IMin AscendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = MinClauseImpl.ASC_ORDER_BY;
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public IMin DescendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = MinClauseImpl.DESC_ORDER_BY;
        ...
        /// <param name="columns">Name of columns</param>
        /// <returns>Where instance object</returns>
        public IMin Columns(String[] columns)
        {
        ...
        /// <returns>Where instance object</returns>
        public IMin Delimiter(String delimiter)
        {
        ...
        public double Execute()
        {
            ...
            return DatabaseHelper.Min(entityDescriptor, column, where, groupBy.ToList().GetEnumerator(), having);
        }
    }
}
