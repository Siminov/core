...
namespace Siminov.Core.Database
{
    ...
    /// </summary>
    public class AverageImpl : IAverage
    {
        ...
        private AverageClauseImpl where = null;
        ...
        private AverageClauseImpl having = null;
        ...
        /// <returns>Clause Clause instance object</returns>
        public IAverageClause Where(String column)
        {

            where = new AverageClauseImpl(this);
            where.AddCol(column);
        ...
        /// <returns>Where instance object</returns>
        public IAverage OrderBy(String[] columns)
        {
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public IAverage AscendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = AverageClauseImpl.ASC_ORDER_BY;
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public IAverage DescendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = AverageClauseImpl.DESC_ORDER_BY;
        ...
        /// <returns>Where instance object</returns>
        public IAverage Limit(int limit)
        {
            this.limit = limit;
            return this;
        }
        ...
        public IAverageClause Having(String column)
        {
            ...
            having = new AverageClauseImpl(this);
        ...
        /// <param name="columns">Name of columns</param>
        /// <returns>Where instance object</returns>
        public IAverage Columns(String[] columns)
        {
        ...
        /// <returns>Where instance object</returns>
        public IAverage Delimiter(String delimiter)
        {
        ...
        public double Execute()
        {
            ...
            return DatabaseHelper.Avg(entityDescriptor, column, where, groupBy.ToList().GetEnumerator(), having);
        }
    }
}
