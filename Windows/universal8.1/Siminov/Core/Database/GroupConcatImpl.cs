...
namespace Siminov.Core.Database
{
    ...
    /// </summary>
    public class GroupConcatImpl : IGroupConcat
    {
        ...
        private GroupConcatClauseImpl where = null;
        ...
        private GroupConcatClauseImpl having = null;
        ...
        public IGroupConcatClause Where(String column)
        {
            ...
            where = new GroupConcatClauseImpl(this);
            where.AddCol(column);
        ...
        /// <returns>Where Where instance object</returns>
        public IGroupConcat OrderBy(String[] columns)
        {
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public IGroupConcat AscendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = GroupConcatClauseImpl.ASC_ORDER_BY;
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public IGroupConcat DescendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = GroupConcatClauseImpl.DESC_ORDER_BY;
        ...
        /// <returns>Where instance object</returns>
        public IGroupConcat Limit(int limit)
        {
            this.limit = limit;
            return this;
        }
        ...
        public IGroupConcatClause Having(String column)
        {
            ...
            having = new GroupConcatClauseImpl(this);
        ...
        /// <param name="columns">Name of columns</param>
        /// <returns>Where instance object</returns>
        public IGroupConcat Columns(String[] columns)
        {
        ...
        public String Execute()
        {
            ...
            return DatabaseHelper.GroupConcat(entityDescriptor, column, delimiter, where, groupBy.ToList().GetEnumerator(), having);
        }
    }
}
