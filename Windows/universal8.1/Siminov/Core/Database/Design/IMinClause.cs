...
namespace Siminov.Core.Database.Design
{
    ...
    public interface IMinClause
    {
        ...
        /// <returns>IMax Interface</returns>
        IMin GreaterThanEqual(Object value);
        ...
        /// <returns>IMax Interface</returns>
        IMin LessThanEqual(Object value);
        ...
        /// <returns>IMax Interface</returns>
        IMin Between(Object start, Object end);
