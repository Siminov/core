...
namespace Siminov.Core.Database.Design
{
    ...
    public interface ISumClause
    {
        ...
        /// <returns>ISum Interface</returns>
        ISum GreaterThanEqual(Object value);
        ...
        /// <returns>ISum Interface</returns>
        ISum LessThanEqual(Object value);
        ...
        /// <returns>ISum Interface</returns>
        ISum Between(Object start, Object end);
