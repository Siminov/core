...
namespace Siminov.Core.Database.Design
{
    ...
    public interface IMaxClause
    {
        ...
        /// <returns>IMax Interface</returns>
        IMax GreaterThanEqual(Object value);
        ...
        /// <returns>IMax Interface</returns>
        IMax LessThanEqual(Object value);
        ...
        /// <returns>IMax Interface</returns>
        IMax Between(Object start, Object end);
