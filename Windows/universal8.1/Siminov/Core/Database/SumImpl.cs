...
namespace Siminov.Core.Database
{
    ...
    public class SumImpl : ISum
    {
        ...
        private SumClauseImpl where = null;
        ...
        private SumClauseImpl having = null;
        ...
        public SumImpl(EntityDescriptor entityDescriptor, Object referObject)
        {
            this.entityDescriptor = entityDescriptor;
        ...
        /// <returns>Where instance object</returns>
        public ISum OrderBy(String[] columns)
        {
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public ISum AscendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = SumClauseImpl.ASC_ORDER_BY;
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public ISum DescendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = SumClauseImpl.DESC_ORDER_BY;
        ...
        /// <param name="columns">Name of columns</param>
        /// <returns>Where instance object</returns>
        public ISum Columns(String[] columns)
        {
        ...
        /// <returns>Where instance object</returns>
        public ISum Delimiter(String delimiter)
        {
