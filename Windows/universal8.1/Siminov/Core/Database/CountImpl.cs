...
namespace Siminov.Core.Database
{
    ...
    public class CountImpl : ICount
    {
        ...
        private CountClauseImpl where = null;
        ...
        private CountClauseImpl having = null;
        ...
        public ICountClause Where(String column)
        {
            ...
            where = new CountClauseImpl(this);
            where.AddCol(column);
        ...
        /// <returns>Where instance object</returns>
        public ICount OrderBy(String[] columns)
        {
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public ICount AscendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = CountClauseImpl.ASC_ORDER_BY;
        ...
        /// <param name="columns">Name of columns which need to be sorted</param>
        /// <returns>Where instance object</returns>
        public ICount DescendingOrderBy(String[] columns)
        {
            this.orderBy = columns;
            this.whichOrderBy = CountClauseImpl.DESC_ORDER_BY;
        ...
        public ICountClause Having(String column)
        {
            ...
            having = new CountClauseImpl(this);
        ...
        /// <param name="columns">Name of columns</param>
        /// <returns>Where instance object</returns>
        public ICount Columns(String[] columns)
        {
        ...
        /// <returns>Where instance object</returns>
        public ICount Delimiter(String delimiter)
        {
        ...
        public int Execute()
        {
            ...
            return DatabaseHelper.Count(entityDescriptor, column, distinct, where, groupBy.ToList().GetEnumerator(), having);
        }
    }
}
