...
{
    public class PrematureEndOfParseException : System.Exception, IException
    {
        ...
        public PrematureEndOfParseException(String className, String methodName, String message)
        {
