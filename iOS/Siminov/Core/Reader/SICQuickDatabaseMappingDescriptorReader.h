 ...
 */
@interface SICQuickDatabaseMappingDescriptorReader : SICSiminovSAXDefaultHandler {
    NSMutableString *tempValue;
    NSString *finalDatabaseMappingBasedOnClassName;
...
/**
 * QuickDatabaseMappingDescriptorReader Constructor
