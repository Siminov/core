	...
	public Iterator<Map<String, Object>> executeFetchQuery(final DatabaseDescriptor databaseDescriptor, final DatabaseMappingDescriptor databaseMappingDescriptor, final String query) throws DatabaseException {
			...
			while(sqliteCursor.moveToNext()) {
				...
				for(int i = 0;i < columnNames.length;i++) {
					...
					if(column == null) {
						Log.loge(Database.class.getName(), "executeFetchQuery", "No Column Object Found For Column Name: " + columnName);
						throw new DatabaseException(Database.class.getName(), "executeFetchQuery", "No Column Object Found For Column Name: " + columnName);
					}
					
					String columnType = column.getType();
					if(columnType == null || columnType.length() <= 0) {
						Log.loge(Database.class.getName(), "executeFetchQuery", "No Column Type Found For Column Name: " + columnName);
						throw new DatabaseException(Database.class.getName(), "executeFetchQuery", "No Column Type Found For Column Name: " + columnName);
					}
